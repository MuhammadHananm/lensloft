...
# Image analysis function (optional)
        ...
        if file and title and file.filename != '':
            ...
            try:
                ...
                if blob_service_client and AZURE_CONTAINER_NAME:
                    ...
                    flash('Azure storage is not configured. Uploads are disabled.', 'danger')
...
# Likes, saves, comments (same as before)...
